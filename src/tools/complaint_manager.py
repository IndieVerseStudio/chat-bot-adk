...
def _get_complaints_file_path() -> str:
    """Get the path to the complaints JSON file."""
...
def auto_create_complaint_if_needed(opus_id: str, customer_name: str, days_since_kyc: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if days_since_kyc > 30:
            ...
            complaint_result = create_complaint(
                opus_id=opus_id,
...
def create_complaint(opus_id: str, customer_name: str, complaint_type: str, 
                    subject: str, issue_description: str, priority: str = "standard") -> Dict[str, Any]:
...
def create_enquiry(opus_id: str, customer_name: str, enquiry_type: str, 
...
auto_create_complaint_tool = FunctionTool(func=auto_create_complaint_if_needed)
create_complaint_tool = FunctionTool(func=create_complaint)
create_enquiry_tool = FunctionTool(func=create_enquiry)
